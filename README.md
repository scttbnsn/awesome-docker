...
- [Drydock](https://github.com/CodesWhat/drydock) - Watch running containers for newer image tags across 23 registries, then notify or apply the update itself.
...
- [sockguard](https://github.com/CodesWhat/sockguard) - Filter Docker API requests by method and path with a default-deny posture and structured audit logging, as a drop-in replacement for docker-socket-proxy.
